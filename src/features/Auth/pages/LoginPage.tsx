...
import { Shield, CheckCircle, Users, Smile, Lock } from "lucide-react";
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2 mt-6 pt-6 border-t">
                      ...
                      <div className="flex items-center text-muted-foreground text-sm">
                        ...
                        <span>{t("login.trust.nospam")}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      <div className="flex gap-3">
                        ...
                        <div>
                          <div className="font-semibold mb-1">
                            {t("login.why.items.workflow.title")}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            {t("login.why.items.workflow.text")}
                          </div>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          <div className="font-semibold mb-1">
                            {t("login.why.items.security.title")}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            {t("login.why.items.security.text")}
                          </div>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          <div className="font-semibold mb-1">
                            {t("login.why.items.teams.title")}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            {t("login.why.items.teams.text")}
                          </div>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        ...
                        <div>
                          <div className="font-semibold mb-1">
                            {t("login.why.items.ux.title")}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            {t("login.why.items.ux.text")}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="bg-green-600 text-white text-xs font-semibold px-2 py-1 rounded-full">
                          {t("login.stats.percentage")}
                        </span>
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {t("login.stats.caption")}
                      </div>
                    </div>
                  </CardContent>
                </Card>
